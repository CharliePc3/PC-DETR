...
EXPERIMENT="sdsr_v40_match_stage1_seed43"
...
run_cell() {
  local cell="$1"
  shift
  local run_name="coco_medium_s43_detinit1043_sdsr_v40_${cell}_g6_cdn50_l05_lrd20_e24"
...
run_cell dense_nomix \
  --dense-o2o-mosaic-prob 0.5 \
  --dense-o2o-mixup-prob 0.0

run_cell dense_copyonly \
  --dense-o2o-mosaic-prob 0.0 \
  --dense-o2o-mixup-prob 0.0
