...
EXPERIMENT="sdsr_v42_p5_depth_medium_seed43"
...
if [[ ! -f "${SNAPSHOT_ROOT}/.snapshot_complete" ]]; then
  printf 'Missing frozen v42 snapshot: %s\n' "${SNAPSHOT_ROOT}" >&2
  exit 2
fi
exec 9>"${LOCK_FILE}"
if ! flock -n 9; then
...
run_cell "sdsr_v42_p5_uniform_p4strong" "sdsr_v42_p5_uniform"
run_cell "sdsr_v42_p5_deep_p4strong" "sdsr_v42_p5_deep"
