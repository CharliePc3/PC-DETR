...
def build_backbone(
    ...
    projector_source_mode="mask",
    projector_c2f_blocks=None,
    projector_resample_share="none",
    ...
    backbone = Backbone(
        ...
        projector_source_mode=projector_source_mode,
        projector_c2f_blocks=projector_c2f_blocks,
        projector_resample_share=projector_resample_share,
