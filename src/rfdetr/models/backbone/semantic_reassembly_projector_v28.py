...
"""Narrow deepest-layer grouped detail sampling for P5 reassembly."""
...
class ScaleDecoupledReassemblyProjectorV28(
    ScaleDecoupledReassemblyProjectorV23
):
    """Let each deepest-layer detail group mix 12 DINOv3-S channels."""
