...
EXPERIMENT="sdsr_v39_p4_routing_medium_seed43"
...
run_cell \
  ...
  "sdsr_v23" \
  "Seed43 same-snapshot v23 control"
run_cell \
  "sdsr_v39_p4_staticroute_c2f" \
  "sdsr_v39_p4_static" \
  "Four-parameter normalized global ViT-depth prior before the P4 C2f"
run_cell \
  "sdsr_v38_p4_dynamicroute_c2f" \
  "sdsr_v38_p4" \
  "Per-image normalized ViT-layer routing before the P4 C2f"
