...
EXPERIMENT="sdsr_v40_match_stage3_cdn_seed43"
...
run_cell() {
  local cell="$1"
  shift
  local run_name="coco_medium_s43_detinit1043_sdsr_v40_dense_nomix_g6_${cell}_lrd20_e24"
...
run_cell nocdn
run_cell cdn25_l05 --use-cdn --dn-number 25 --dn-loss-coef 0.5
run_cell cdn50_l03 --use-cdn --dn-number 50 --dn-loss-coef 0.3
